...
function getCategoryEmoji(cat) {
  ...
  const map = {
    ...
    'documents': '<i class="fa-solid fa-file-lines" aria-hidden="true"></i>', 'id / documents': '<i class="fa-solid fa-id-card" aria-hidden="true"></i>', 'books': '<i class="fa-solid fa-book" aria-hidden="true"></i>',
    'books / stationery': '<i class="fa-solid fa-book" aria-hidden="true"></i>', 'keys': '<i class="fa-solid fa-key" aria-hidden="true"></i>', 'bags': '<i class="fa-solid fa-briefcase" aria-hidden="true"></i>', 'others': '<i class="fa-solid fa-box" aria-hidden="true"></i>'
  };
