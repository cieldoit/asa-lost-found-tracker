...
function handleAvatarChange(input) {
  ...
  document.getElementById('avatarFileName').textContent = name;
  showToast('info', 'Photo Selected', `"${name}" is ready. Click Update to save.`);
}
...
function renderRecentItems(items) {
  const box = document.getElementById('recentItemsContainer');
  if (!box) return;
  box.innerHTML = '';
