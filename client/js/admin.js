...
function ensureAdminMyPostDeleteModal() {
  ensureAdminMyPostActionStyles();
...
function openAdminMyPostDeleteModal(item) {
  const overlay = ensureAdminMyPostDeleteModal();
...
async function deleteAdminMyPost(item) {
  ...
  openAdminMyPostDeleteModal(item);
}
...
function buildAdminItemCard(item) {
  ...
  const editedRaw = item.editedAt || null;
